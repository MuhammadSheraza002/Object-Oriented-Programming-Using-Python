...
class BMP:
    ...
    def merge(self, image, percentage1, percentage2):
        ...
        for i in range(clrs_count):
           clr_list[i] = self.clrs[i] * percentage1 // 100 + image.clrs[i] * percentage2 // 100
...
def main():
    ...
    image3 = image1.merge(image2, 20, 80)
    image3.write_image('merge_20_80.bmp')
